...
// Other test functions remain largely the same, but replacing rtmClient with rtmService where needed
...
// Other test functions would be similarly updated but simplified here
