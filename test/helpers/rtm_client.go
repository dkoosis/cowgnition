...
// RTMTestClient wraps the RTM client with testing-specific functionality
// such as rate limiting, error reporting, and conditional execution.
...
// NewRTMTestClient creates a new RTM test client using credentials from
// environment variables or a provided API key and shared secret.
...
// ShouldSkipLiveTests returns true if live RTM tests should be skipped.
